...
#include "SWE_MICWaveAccumulationBlockIntrinsic.hh"
#include <immintrin.h>
#ifdef LOOP_OPENMP
#include <omp.h>
#endif
 ...
 *
 */
SWE_MICWaveAccumulationBlockIntrinsic::SWE_MICWaveAccumulationBlockIntrinsic(
		int l_nx, int l_ny,
 ...
 */
void SWE_MICWaveAccumulationBlockIntrinsic::computeNumericalFluxes() {
 ...
 */
void SWE_MICWaveAccumulationBlockIntrinsic::updateUnknowns(float dt) {
