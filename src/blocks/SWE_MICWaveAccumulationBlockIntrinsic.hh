...
#ifndef SWE_MICWAVEACCUMULATION_BLOCK_HH_
#define SWE_MICWAVEACCUMULATION_BLOCK_HH_
...
#include "solvers/FWaveMICIntrinsicTrace.hpp"
#else
 ...
 */
class SWE_MICWaveAccumulationBlockIntrinsic: public SWE_Block {
    ...
    //! Vectorized FWave solver
     ...
     solver::FWaveMICIntrinsicTrace<float> wavePropagationSolver;
  ...
  public:
    ...
    SWE_MICWaveAccumulationBlockIntrinsic(int l_nx, int l_ny, float l_dx, float l_dy);
    //destructor of a SWE_WaveAccumulationBlock.
    virtual ~SWE_MICWaveAccumulationBlockIntrinsic() {}
