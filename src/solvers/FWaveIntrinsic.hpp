...
public:
	...
	void print_isic(__m256 intr, std::string label) const {
	 ...
	 */
	void computeNetUpdates(__m256 i_hLeft, __m256 i_hRight, __m256 i_huLeft, __m256 i_huRight, __m256 i_bLeft, __m256 i_bRight,

	__m256 &o_hUpsateLeft, __m256 &o_hUpsateRight, __m256 &o_huUpsateLeft, __m256 &o_huUpsateRight, __m256 &o_maxWaveSpeed) const {
